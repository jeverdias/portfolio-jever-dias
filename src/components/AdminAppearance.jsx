...
export function AdminAppearance({ siteStore }) {
  ...
  return <div className="admin-appearance">
    ...
    <section className="appearance-section"><div className="appearance-section__heading"><span>45 sugestões profissionais</span><h4>Escolha pelo setor</h4><p>Visualize primeiro ou aplique a combinação de paleta e estilo.</p></div><div className="appearance-presets">
    ...
    <section className="appearance-section"><div className="appearance-section__heading"><span>32 combinações de cores</span><h4>Paletas</h4><p>Troque somente as cores, mantendo o design.</p></div><div className="appearance-palettes">
    ...
    <section className="appearance-section"><div className="appearance-section__heading"><span>30 modelos em 3 colunas</span><h4>Estilos de design</h4><p>Troque acabamento, cantos e personalidade sem mudar o conteúdo.</p></div><div className="appearance-designs">
    ...
    <section className="appearance-section"><div className="appearance-section__heading"><span>30 combinações em 3 colunas</span><h4>Fontes do site</h4><p>Troque a fonte sem alterar textos ou organização.</p></div><div className="appearance-fonts">
